...
[CustomEditor(typeof(MegaHoseNew))]
public class MegaHoseNewEditor : Editor
{
	...
	static void CreatePageMesh()
	{
		...
		MegaHoseNew pm = go.AddComponent<MegaHoseNew>();
	...
	{
		MegaHoseNew mod = (MegaHoseNew)target;
		...
		mod.usesizecurve = EditorGUILayout.BeginToggleGroup("Use Size Curve", mod.usesizecurve);
		mod.size = EditorGUILayout.CurveField("Size", mod.size);
		EditorGUILayout.EndToggleGroup();
	...
	{
		MegaHoseNew hose = (MegaHoseNew)target;
...
#endif
	static void RenderGizmo(MegaHoseNew hose, GizmoType gizmoType)
	{
	...
	static void DrawGizmos(MegaHoseNew hose, Color modcol1)
	{
		Matrix4x4 RingTM = Matrix4x4.identity;
